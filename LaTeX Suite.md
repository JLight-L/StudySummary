	...
	//{trigger: "-q", replacement: "\n #？？？\n> *Question.* \n> ", options: "t"},
	{trigger: "；；", replacement: "  【 #推导 】", options: "t"},
	{trigger: "star", replacement: "⭐⭐⭐", options: "t"},


	// Math mode
	{trigger: "mk", replacement: " $$0$ ", options: "t",priority: 1},
	...
	{trigger: "@p", replacement: "\\rho", options: "mA"},
    ...
    {trigger: "x*", replacement: "\\times", options: "mA"},
    ...
    {trigger: "ppar", replacement: "\\frac{ \\partial^2 ${0:y} }{ \\partial ${1:x}^2 } $2", options: "m"},
	...
	{trigger: "kps", replacement: "\\ket{\\psi} $0", options: "mA"},
	{trigger: "brk", replacement: "\\braket{ $0 | $1 } $2", options: "mA"},
    {trigger: "outer", replacement: "\\ket{${0:\\psi}} \\bra{${0:\\psi}} $1", options: "mA"},

	//Thermal physics
	{trigger: "par;", replacement: "\\left( \\frac{ \\partial ${0:y} }{ \\partial ${1:x} } \\right)_{${2:z}}", options: "m"},//with foot note
